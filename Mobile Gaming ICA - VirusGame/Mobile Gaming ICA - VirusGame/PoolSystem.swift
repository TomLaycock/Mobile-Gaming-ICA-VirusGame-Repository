...
class PoolSystem
{
    ...
    func SetupPoolSystem(scene Scene: GameScene)
    {
        ...
        for _ in 1...20
        {
            let newEnergyBall = EnergyBall(imageNamed: "Energy/BasicFood")
        ...
        for _ in 1...10
        {
            let newWhiteBloodCell = WhiteBloodCell(back: "Viruses/WhiteBloodCell-0000-SpikesOnly", front: "Viruses/WhiteBloodCell-0000-BodyOnly", speed: Float(1))
